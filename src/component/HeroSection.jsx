...
function HeroSection() {
  return (
    <section className="text-center sm:py-12">
      <h2 className=" text-2xl md:text-8xl mt-18 md:mt-0 font-extrabold md:leading-20 leading-6 px-[4rem] sm:max-w-6xl min-w-1xl md:px-[0rem] m-auto mb-[2rem] sm:mb-[0rem]  text-[#E9E3DC]">
